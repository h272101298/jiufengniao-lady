     ...
     <el-tabs v-model="activeName" type="card">
      <el-tab-pane label="奖品设置" name="list">
        <el-form ref="signset" :model="signset" label-width="160px" class="form" status-icon size="small" style="width:600px;" :rules="signrule">
          ...
          <el-form-item label="二等奖：" prop="twnum">
          ...
          <el-form-item label="三等奖：" prop="trnum">
          ...
          <el-form-item label="四等奖：" prop="fonum">
          ...
          <el-form-item label="五等奖：" prop="finum">
          ...
          <el-form-item label="六等奖：" prop="sinum">
          ...
          <el-form-item label="七等奖：" prop="senum">
          ...
          <el-form-item label="八等奖：" prop="senum">
            <el-input class="numinput" placeholder="请输入奖励数量" v-model="signset.eignum" v-show="show"><template slot="append">积分</template></el-input>
            <div v-show="set" class="showlabel">
              <label v-show="set">{{signdata[7].reward}}积分</label>
            </div>
          </el-form-item>
      ...
      <el-tab-pane label="转发获得积分" name="config">
      </el-tab-pane>
    ...
    data() {
      ...
      return {
        ...
        signrule:{
          ...
          eignum:[{required: true, trigger: 'blur',validator: checkvalue}]
        },
      }      
    },
